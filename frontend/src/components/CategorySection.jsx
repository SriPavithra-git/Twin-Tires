...
export default function CategorySection({ categories = [], onSelect = () => {} }) {
  ...
  return (
    <section className="py-10 px-6 bg-[#0d0d0d] text-white">
        ...
        <div className="flex gap-4 snap-x snap-mandatory">
          {categories.map((cat) => (
            <button
              ...
              className="group relative flex flex-col overflow-hidden rounded-xl bg-[#151515] border border-[#ff6600]/10 shadow-[0_6px_16px_rgba(0,0,0,0.5)] hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_12px_28px_rgba(255,136,0,0.15)] w-[240px] flex-shrink-0 snap-center"
            >
      ...
      {/* ✅ Keep your original grid for tablets/desktops */}
